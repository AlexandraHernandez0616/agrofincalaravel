...
<head>
  ...
  <title>{{ $title ?? 'Portal del Trabajador' }} - AgroFinca</title>
  <meta name="description" content="Portal del Trabajador - AgroFinca." />
...
<body>
  ...
  <div class="admin-layout">
    ...
    <!-- Menú Lateral del Trabajador -->
    @include('trabajador.layouts.sidebar')

    <!-- Área de Contenido Principal -->
    <div class="admin-content-area">
      <!-- Header Superior -->
      @include('trabajador.layouts.header')
      ...
      <!-- Footer & Scripts -->
      @include('trabajador.layouts.footer')
    </div>
